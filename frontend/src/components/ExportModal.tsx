        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-[#F6F5F0] rounded-lg shadow-xl w-full max-w-md p-8 border border-gray-200">
                <div className="text-center mb-6">
                    ...
                    <h2 className="font-serif text-2xl font-bold text-gray-900">Export File</h2>
                    <p className="text-sm text-gray-500 font-serif italic mt-1">Choose your export format</p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-4">
                        <label className="block text-sm font-serif font-medium text-gray-700">
                            Format
                        </label>
                        <div className="grid grid-cols-2 gap-4">
                            <button
                                ...
                                className={`p-4 border-2 rounded-lg font-serif text-center transition-colors ${
                                    format === 'stl' 
